...
#(2) Makine Öğrenmsi Modelinin Seçilmesi - KNN Sınıflandırıcı
...
knn.fit(X_train, y_train) #fit foksiyonu verimizi (samples + target) kullanarak knn algoritmasını egitir
